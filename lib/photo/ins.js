var host = 'https://ennis.sgp1.cdn.digitaloceanspaces.com/image/';
/******/
    ...
    function(module, exports, __webpack_require__) {
      ...
      var render = function render(res) {
        ...
        for (var j = 0, len2 = res.list.length; j < len2; j++) {
          ...
          for (var i = 0, len = data.link.length; i < len; i++) {
            ...
            var minSrc = host + 'photos_min/' + data.link[i];
            var src = host + 'photos/' + data.link[i];
            ...
            liTmpl += '<figure class="thumb" itemprop="associatedMedia" itemscope="" itemtype="http://schema.org/ImageObject">\
                  <a href="' + src + '" itemprop="contentUrl" data-size="' + solution + '" data-type="' + type + '" data-target="' + src + '">\
                    <img class="reward-img" data-type="' + type + '" data-src="' + minSrc + '" src="/lib/photo/assets/empty.png" itemprop="thumbnail" onload="lzld(this)">\
                  </a>\
                  <figcaption style="display:none" itemprop="caption description">' + data.text[i] + '</figcaption>\
              </figure>';
          }
          ulTmpl = ulTmpl + '<section class="archives album"><h1 class="year">' + data.year + '年<em>' + data.month + '月</em></h1>\
          <ul class="img-box-ul" style="padding-left: 0px;">' + liTmpl + '</ul>\
          </section>';
        }
      ...
      function loadData(success) {
        if (!searchData) {
          ...
          xhr.open('GET', '/lib/photo/data.json?t=' + +new Date(), true);
