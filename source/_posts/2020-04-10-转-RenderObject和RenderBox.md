---
title: '「转载」RenderObject 和 RenderBox'
date: 2020-04-10 19:28:51
tags: [Flutter]
categories: Flutter
---

转自：[14.3 RenderObject和RenderBox](https://book.flutterchina.club/chapter14/render_object.html)
...
当需要绘制的内容大小溢出当前空间时，将会执行`paintOverflowIndicator()` 来绘制溢出部分提示，这个就是我们经常看到的溢出提示，如图所示：

![overflow](/images/posts/Flutter/overflow.png)
